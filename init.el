...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Playground/org-mode/examples/todo/Readme.org")))
...
(add-hook 'cc-mode-hook 'remove-dos-eol)
(add-hook 'c++-mode-hook 'remove-dos-eol)

(add-to-list 'load-path "/Users/Winmad/.emacs.d/elpa/neotree-0.2")
(require 'neotree)
